...
void minithread_system_initialize(proc_t mainproc, arg_t mainarg) {
	...
	register_alarm(3000*ONE_MILLISECOND, print_al, &current_tick);
	register_alarm(6000*ONE_MILLISECOND, print_al, &current_tick);
	register_alarm(9000*ONE_MILLISECOND, print_al, &current_tick);
	register_alarm(12000*ONE_MILLISECOND, print_al, &current_tick);
